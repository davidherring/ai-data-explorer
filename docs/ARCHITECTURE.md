...
Strava API responses should be converted into the internal normalized ride model before entering the analytical layer.
...
normalized ride data or cached API results;
...
Weather fields should enter through the same normalization/enrichment boundary as other ride data.
...
sparse selection;
follow-up reference such as "those rides";
